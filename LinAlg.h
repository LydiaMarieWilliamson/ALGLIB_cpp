...
{
#if defined(AE_COMPILE_ABLAS) || !defined(AE_PARTIAL_BUILD)
void ablassplitlength(RMatrix * a,
     ae_int_t n,
     ae_int_t* n1,
     ae_int_t* n2,
     ae_state *_state);
void ablascomplexsplitlength(CMatrix * a,
     ae_int_t n,
     ae_int_t* n1,
     ae_int_t* n2,
     ae_state *_state);
...
void generatereflection(RVector * x,
     ae_int_t n,
     double* tau,
     ae_state *_state);
void applyreflectionfromtheleft(RMatrix * c,
     double tau,
     RVector * v,
     ae_int_t m1,
     ae_int_t m2,
     ...
     RVector * work,
     ae_state *_state);
void applyreflectionfromtheright(RMatrix * c,
     double tau,
     RVector * v,
     ae_int_t m1,
     ae_int_t m2,
...
void rmatrixtranspose(ae_int_t m,
     ...
     ae_int_t jb,
     ae_state *_state);
void rmatrixenforcesymmetricity(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
...
void cmatrixsyrk(ae_int_t n,
     ...
     ae_bool isupper,
     ae_state *_state);
void rowwisegramschmidt(RMatrix * q,
     ae_int_t m,
     ae_int_t n,
     RVector * x,
     RVector * qx,
...
#endif
#if defined(AE_COMPILE_ORTFAC) || !defined(AE_PARTIAL_BUILD)
void rmatrixqr(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * tau,
     ae_state *_state);
void rmatrixlq(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * tau,
     ae_state *_state);
void cmatrixqr(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CVector * tau,
     ae_state *_state);
void cmatrixlq(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CVector * tau,
     ae_state *_state);
void rmatrixqrunpackq(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * tau,
     ae_int_t qcolumns,
     RMatrix * q,
     ae_state *_state);
void rmatrixqrunpackr(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RMatrix * r,
     ae_state *_state);
void rmatrixlqunpackq(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * tau,
     ae_int_t qrows,
     RMatrix * q,
     ae_state *_state);
void rmatrixlqunpackl(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RMatrix * l,
     ae_state *_state);
void cmatrixqrunpackq(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CVector * tau,
     ae_int_t qcolumns,
     CMatrix * q,
     ae_state *_state);
void cmatrixqrunpackr(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CMatrix * r,
     ae_state *_state);
void cmatrixlqunpackq(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CVector * tau,
     ae_int_t qrows,
     CMatrix * q,
     ae_state *_state);
void cmatrixlqunpackl(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     CMatrix * l,
     ae_state *_state);
void rmatrixqrbasecase(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * work,
     RVector * t,
     RVector * tau,
     ae_state *_state);
void rmatrixlqbasecase(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * work,
     RVector * t,
     RVector * tau,
     ae_state *_state);
void rmatrixbd(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     RVector * tauq,
     RVector * taup,
     ae_state *_state);
void rmatrixbdunpackq(RMatrix * qp,
     ae_int_t m,
     ae_int_t n,
     RVector * tauq,
     ae_int_t qcolumns,
     RMatrix * q,
     ae_state *_state);
void rmatrixbdmultiplybyq(RMatrix * qp,
     ae_int_t m,
     ae_int_t n,
     RVector * tauq,
     RMatrix * z,
     ...
     ae_bool dotranspose,
     ae_state *_state);
void rmatrixbdunpackpt(RMatrix * qp,
     ae_int_t m,
     ae_int_t n,
     RVector * taup,
     ae_int_t ptrows,
     RMatrix * pt,
     ae_state *_state);
void rmatrixbdmultiplybyp(RMatrix * qp,
     ae_int_t m,
     ae_int_t n,
     RVector * taup,
     RMatrix * z,
     ...
     ae_bool dotranspose,
     ae_state *_state);
void rmatrixbdunpackdiagonals(RMatrix * b,
     ae_int_t m,
     ae_int_t n,
     ae_bool* isupper,
     RVector * d,
     RVector * e,
     ae_state *_state);
void rmatrixhessenberg(RMatrix * a,
     ae_int_t n,
     RVector * tau,
     ae_state *_state);
void rmatrixhessenbergunpackq(RMatrix * a,
     ae_int_t n,
     RVector * tau,
     RMatrix * q,
     ae_state *_state);
void rmatrixhessenbergunpackh(RMatrix * a,
     ae_int_t n,
     RMatrix * h,
     ae_state *_state);
void smatrixtd(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     RVector * tau,
     RVector * d,
     RVector * e,
     ae_state *_state);
void smatrixtdunpackq(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     RVector * tau,
     RMatrix * q,
     ae_state *_state);
void hmatrixtd(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     CVector * tau,
     RVector * d,
     RVector * e,
     ae_state *_state);
void hmatrixtdunpackq(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     CVector * tau,
     CMatrix * q,
...
void hpdmatrixrndcond(ae_int_t n,
     ...
     CMatrix * a,
     ae_state *_state);
void rmatrixrndorthogonalfromtheright(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ae_state *_state);
void rmatrixrndorthogonalfromtheleft(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ae_state *_state);
void cmatrixrndorthogonalfromtheright(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ae_state *_state);
void cmatrixrndorthogonalfromtheleft(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ae_state *_state);
void smatrixrndmultiply(RMatrix * a,
     ae_int_t n,
     ae_state *_state);
void hmatrixrndmultiply(CMatrix * a,
     ae_int_t n,
     ae_state *_state);
#endif
#if defined(AE_COMPILE_SPARSE) || !defined(AE_PARTIAL_BUILD)
...
#endif
#if defined(AE_COMPILE_HSSCHUR) || !defined(AE_PARTIAL_BUILD)
void rmatrixinternalschurdecomposition(RMatrix * h,
     ae_int_t n,
     ae_int_t tneeded,
     ae_int_t zneeded,
     RVector * wr,
     ...
     ae_int_t* info,
     ae_state *_state);
ae_bool upperhessenbergschurdecomposition(RMatrix * h,
     ae_int_t n,
     RMatrix * s,
     ae_state *_state);
void internalschurdecomposition(RMatrix * h,
     ae_int_t n,
     ae_int_t tneeded,
     ae_int_t zneeded,
     RVector * wr,
...
ae_bool hmatrixevdi(CMatrix * a,
     ...
     CMatrix * z,
     ae_state *_state);
ae_bool smatrixtdevd(RVector * d,
     RVector * e,
     ae_int_t n,
     ae_int_t zneeded,
     RMatrix * z,
     ae_state *_state);
ae_bool smatrixtdevdr(RVector * d,
     RVector * e,
     ae_int_t n,
     ae_int_t zneeded,
     double a,
     ...
     RMatrix * z,
     ae_state *_state);
ae_bool smatrixtdevdi(RVector * d,
     RVector * e,
     ae_int_t n,
     ae_int_t zneeded,
     ae_int_t i1,
...
#endif
#if defined(AE_COMPILE_TRFAC) || !defined(AE_PARTIAL_BUILD)
void rmatrixlu(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
void cmatrixlu(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
ae_bool hpdmatrixcholesky(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
ae_bool spdmatrixcholesky(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
void spdmatrixcholeskyupdateadd1(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     RVector * u,
     ae_state *_state);
void spdmatrixcholeskyupdatefix(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     BVector * fix,
     ae_state *_state);
void spdmatrixcholeskyupdateadd1buf(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     RVector * u,
     RVector * bufr,
     ae_state *_state);
void spdmatrixcholeskyupdatefixbuf(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     BVector * fix,
     RVector * bufr,
...
void sparsecholeskyreload(sparsedecompositionanalysis* analysis,
     ...
     ae_bool isupper,
     ae_state *_state);
void rmatrixlup(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
void cmatrixlup(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
void rmatrixplu(RMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
void cmatrixplu(CMatrix * a,
     ae_int_t m,
     ae_int_t n,
     ZVector * pivots,
     ae_state *_state);
ae_bool spdmatrixcholeskyrec(RMatrix * a,
     ae_int_t offs,
     ae_int_t n,
     ae_bool isupper,
     RVector * tmp,
...
#endif
#if defined(AE_COMPILE_BDSVD) || !defined(AE_PARTIAL_BUILD)
ae_bool rmatrixbdsvd(RVector * d,
     RVector * e,
     ae_int_t n,
     ae_bool isupper,
     ...
     ae_int_t ncvt,
     ae_state *_state);
ae_bool bidiagonalsvddecomposition(RVector * d,
     RVector * e,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isfractionalaccuracyrequired,
...
#endif
#if defined(AE_COMPILE_RCOND) || !defined(AE_PARTIAL_BUILD)
double rmatrixrcond1(RMatrix * a,
     ae_int_t n,
     ae_state *_state);
double rmatrixrcondinf(RMatrix * a,
     ae_int_t n,
     ae_state *_state);
double spdmatrixrcond(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
double rmatrixtrrcond1(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_state *_state);
double rmatrixtrrcondinf(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_state *_state);
double hpdmatrixrcond(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
double cmatrixrcond1(CMatrix * a,
     ae_int_t n,
     ae_state *_state);
double cmatrixrcondinf(CMatrix * a,
     ae_int_t n,
     ae_state *_state);
double rmatrixlurcond1(RMatrix * lua,
     ae_int_t n,
     ae_state *_state);
double rmatrixlurcondinf(RMatrix * lua,
     ae_int_t n,
     ae_state *_state);
double spdmatrixcholeskyrcond(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
double hpdmatrixcholeskyrcond(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
double cmatrixlurcond1(CMatrix * lua,
     ae_int_t n,
     ae_state *_state);
double cmatrixlurcondinf(CMatrix * lua,
     ae_int_t n,
     ae_state *_state);
double cmatrixtrrcond1(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_state *_state);
double cmatrixtrrcondinf(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_state *_state);
...
#endif
#if defined(AE_COMPILE_FBLS) || !defined(AE_PARTIAL_BUILD)
void fblscholeskysolve(RMatrix * cha,
     double sqrtscalea,
     ae_int_t n,
     ae_bool isupper,
     RVector * xb,
...
#endif
#if defined(AE_COMPILE_MATINV) || !defined(AE_PARTIAL_BUILD)
void rmatrixluinverse(RMatrix * a,
     ZVector * pivots,
     ae_int_t n,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void rmatrixinverse(RMatrix * a,
     ae_int_t n,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void cmatrixluinverse(CMatrix * a,
     ZVector * pivots,
     ae_int_t n,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void cmatrixinverse(CMatrix * a,
     ae_int_t n,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void spdmatrixcholeskyinverse(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void spdmatrixinverse(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void hpdmatrixcholeskyinverse(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void hpdmatrixinverse(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void rmatrixtrinverse(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void cmatrixtrinverse(CMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_bool isunit,
     ae_int_t* info,
     matinvreport* rep,
     ae_state *_state);
void spdmatrixcholeskyinverserec(RMatrix * a,
     ae_int_t offs,
     ae_int_t n,
     ae_bool isupper,
     RVector * tmp,
     ae_state *_state);
ae_bool _trypexec_spdmatrixcholeskyinverserec(RMatrix * a,
    ae_int_t offs,
    ae_int_t n,
    ae_bool isupper,
    RVector * tmp, ae_state *_state);
...
#endif
#if defined(AE_COMPILE_INVERSEUPDATE) || !defined(AE_PARTIAL_BUILD)
void rmatrixinvupdatesimple(RMatrix * inva,
     ae_int_t n,
     ae_int_t updrow,
     ae_int_t updcolumn,
     double updval,
     ae_state *_state);
void rmatrixinvupdaterow(RMatrix * inva,
     ae_int_t n,
     ae_int_t updrow,
     RVector * v,
     ae_state *_state);
void rmatrixinvupdatecolumn(RMatrix * inva,
     ae_int_t n,
     ae_int_t updcolumn,
     RVector * u,
     ae_state *_state);
void rmatrixinvupdateuv(RMatrix * inva,
     ae_int_t n,
     RVector * u,
     RVector * v,
     ae_state *_state);
#endif
#if defined(AE_COMPILE_SCHUR) || !defined(AE_PARTIAL_BUILD)
ae_bool rmatrixschur(RMatrix * a,
     ae_int_t n,
     RMatrix * s,
     ae_state *_state);
#endif
#if defined(AE_COMPILE_SPDGEVD) || !defined(AE_PARTIAL_BUILD)
ae_bool smatrixgevd(RMatrix * a,
     ae_int_t n,
     ae_bool isuppera,
     RMatrix * b,
     ae_bool isupperb,
     ...
     RMatrix * z,
     ae_state *_state);
ae_bool smatrixgevdreduce(RMatrix * a,
     ae_int_t n,
     ae_bool isuppera,
     RMatrix * b,
     ae_bool isupperb,
...
#endif
#if defined(AE_COMPILE_MATDET) || !defined(AE_PARTIAL_BUILD)
double rmatrixludet(RMatrix * a,
     ZVector * pivots,
     ae_int_t n,
     ae_state *_state);
double rmatrixdet(RMatrix * a,
     ae_int_t n,
     ae_state *_state);
ae_complex cmatrixludet(CMatrix * a,
     ZVector * pivots,
     ae_int_t n,
     ae_state *_state);
ae_complex cmatrixdet(CMatrix * a,
     ae_int_t n,
     ae_state *_state);
double spdmatrixcholeskydet(RMatrix * a,
     ae_int_t n,
     ae_state *_state);
double spdmatrixdet(RMatrix * a,
     ae_int_t n,
     ae_bool isupper,
     ae_state *_state);
#endif
