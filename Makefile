Cpp=g++
## 1.	This is for SSE2, AVX2 and FMA support (on GCC).
CcOpt=-msse2 -mavx2 -mfma -O3 -DAE_OS=AE_LINUX -DAE_CPU=AE_INTEL -DAE_HAVE_STDINT
## 2.	This is for SSE2 and multi-core support (on GCC).
##	It does not seem to provide any additional benefit.
## CcOpt=-mtune=core2 -msse2 -mavx2 -mfma -O3 -DAE_OS=AE_LINUX -DAE_CPU=AE_INTEL
