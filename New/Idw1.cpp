...
// *	we test that the function value does not change significantly along the line.
   ...
   for (Integer n = 0; n < Ps; n++) {
      XY[3*n][0] = (double)n/(Ps - 1), XY[3*n][1] = -0.1, XY[3*n][2] = 0.0;
      XY[3*n + 1][0] = (double)n/(Ps - 1), XY[3*n + 1][1] = 0.0, XY[3*n + 1][2] = 1.0;
      XY[3*n + 2][0] = (double)n/(Ps - 1), XY[3*n + 2][1] = 0.1, XY[3*n + 2][2] = 0.0;
   }
{
